...
// {{$Contract}}TypeName a unique name of the contract
const {{$Contract}}TypeName = "{{.Path}}"

// I{{$Contract}} is an autogenerated interface
type I{{$Contract}} interface {
{{range .Methods}}    {{symbol .Name}}{{params .Params}}{{returnParams .Return}}{{"\n"}}{{end}}}

//{{$Contract}}Builder service builder used for building local {{$Contract}} service
type {{$Contract}}Builder struct {
    localServiceBuilder func(service gsdock.IService) (I{{$Contract}},error)
}

// New{{$Contract}}Builder creating a new {{$Contract}}Builder
func New{{$Contract}}Builder(localServiceBuilder func(service gsdock.IService)(I{{$Contract}},error)) gsdocker.ITypeBuilder {
...
// NewService creating a new {{$Contract}}Service
func (builder *{{$Contract}}Builder) NewService(name string, id gsdock.ID, context interface{}) (yfdocker.Service,error) {
    c := &{{$Contract}}Service{
        id:id,
        name:name,
