...
func UnmarshalBool(data []byte) (bool, error) {
	if len(data) != 1 {
		return false, cberrors.New("unmarshal bool, data length is not 1")
	}
	if data[0] == 0 {
		return false, nil
	}
...
func UnmarshalByte(data []byte) (byte, error) {
	if len(data) != 1 {
		return 0, cberrors.New("unmarshal byte, data length is not 1")
	}
	return data[0], nil
}
...
func UnmarshalInt8(data []byte) (int8, error) {
	if len(data) != 1 {
		return 0, cberrors.New("unmarshal int8, data length is not 1")
	}
...
func UnmarshalUint8(data []byte) (uint8, error) {
	if len(data) != 1 {
		return 0, cberrors.New("unmarshal uint8, data length is not 1")
	}
	return data[0], nil
}
...
func UnmarshalInt16(data []byte) (int16, error) {
	if len(data) != 2 {
		return 0, cberrors.New("unmarshal int16, data length is not 2")
	}
...
func UnmarshalUint16(data []byte) (uint16, error) {
	if len(data) != 2 {
		return 0, cberrors.New("unmarshal uint16, data length is not 2")
	}
...
func UnmarshalInt32(data []byte) (int32, error) {
	if len(data) != 4 {
		return 0, cberrors.New("unmarshal int32, data length is not 4")
	}
...
func UnmarshalUint32(data []byte) (uint32, error) {
	if len(data) != 4 {
		return 0, cberrors.New("unmarshal uint32, data length is not 4")
	}
...
func UnmarshalInt64(data []byte) (int64, error) {
	if len(data) != 8 {
		return 0, cberrors.New("unmarshal int64, data length is not 8")
	}
...
func UnmarshalUint64(data []byte) (uint64, error) {
	if len(data) != 8 {
		return 0, cberrors.New("unmarshal uint64, data length is not 8")
	}
